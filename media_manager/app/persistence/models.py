...
class IntegrityCheck(Base):
    ...
    last_completed_scan_mode: Mapped[str | None] = mapped_column(Text, nullable=True)
    last_scanned_absolute_path: Mapped[str | None] = mapped_column(Text, nullable=True)
    last_scanned_size_bytes: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    last_scanned_mtime_ns: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
