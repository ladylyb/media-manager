...
export default function DiscoverPage() {
  ...
  }, [page, selectedTags, sortBy, sortOrder]);
    ...
    <div className="p-6 space-y-6 max-w-7xl">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button onClick={() => updateParams({ sort_order: sortOrder === "asc" ? "desc" : "asc", page: "1" })} className="p-1.5 rounded border hover:bg-muted">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
          {data.items.map(file => (
            <div key={file.id} className="rounded-lg border bg-card overflow-hidden hover:border-primary/30 transition-colors group cursor-pointer">
