      ...
      {selectedRun && (
        <div className="w-96 shrink-0 rounded-lg border bg-card p-5 space-y-4 animate-slide-in-right self-start sticky top-0">
          ...
          <div className="space-y-2 text-sm">
            <div>
              <span className="text-muted-foreground">Operation Run ID:</span>{" "}
              <span className="font-mono text-xs">{selectedRun.operation_run_id}</span>
            </div>
            <div>
              <span className="text-muted-foreground">Type:</span> {selectedRun.operation_type}
            </div>
            <div>
              <span className="text-muted-foreground">Status:</span> {selectedRun.status}
            </div>
            <div>
            ...
            <div>
              <span className="text-muted-foreground">Linked Run ID:</span>{" "}
              <span className="font-mono text-xs">{selectedRun.linked_run_id ?? "--"}</span>
            </div>
            <StatusBadge
